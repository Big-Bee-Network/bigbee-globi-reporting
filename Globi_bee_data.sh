...
head -1 output/2022-11-04/indexed_interactions_full.tsv > Andrenidae_data.tsv
head -1 output/2022-11-04/indexed_interactions_full.tsv > Apidae_data.tsv
head -1 output/2022-11-04/indexed_interactions_full.tsv > Colletidae_data.tsv
head -1 output/2022-11-04/indexed_interactions_full.tsv > Halictidae_data.tsv
head -1 output/2022-11-04/indexed_interactions_full.tsv > Megachilidae_data.tsv
head -1 output/2022-11-04/indexed_interactions_full.tsv > Melittidae_data.tsv
head -1 output/2022-11-04/indexed_interactions_full.tsv > Stenotritidae_data.tsv
...
cat output/2022-11-04/indexed_interactions_full.tsv | grep -w "Andrenidae" >> Andrenidae_data.tsv
...
cat output/2022-11-04/indexed_interactions_full.tsv | grep -w "Apidae" >> Apidae_data.tsv
...
cat output/2022-11-04/indexed_interactions_full.tsv | grep -w "Colletidae" >> Colletidae_data.tsv
...
cat output/2022-11-04/indexed_interactions_full.tsv | grep -w "Halictidae" >> Halictidae_data.tsv
...
cat output/2022-11-04/indexed_interactions_full.tsv | grep -w "Megachilidae" >> Megachilidae_data.tsv
...
cat output/2022-11-04/indexed_interactions_full.tsv | grep -w "Melittidae" >> Melittidae_data.tsv
...
cat output/2022-11-04/indexed_interactions_full.tsv | grep -w "Stenotritidae" >> Stenotritidae_data.tsv
...
#####################################
#get counts for each collection and prints
cat indexed_interactions_bees.tsv | cut -f6 | sort > out2.txt
cat out2.txt | uniq -c >> bee_counts.txt
rm out2.txt
cat bee_counts.txt
